          ...
          <div class="flex flex-col max-h-[440px] min-h-[440px]">
            ...
            >
              <input
                ...
                value=""
              /><button class="absolute top-4 right-4  rounded p-2 hover:bg-gray-200" on:click={close} >
                <img
                  src={closeIcon}
                  alt={$t("login.close")}
                          ...
                          >
                            <div class="flex items-center">
                              ...
                              >
                                ...
                                >
                                  <div class="truncate">{result.submit}</div>
                                </div>
                              </div>
                            </div>
                          </div>
