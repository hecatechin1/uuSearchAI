...
>
  ...
  >
    <span class="flex gap-2" data-state="closed">
      <!-- 这里是设置按钮 -->
      <button on:click={showUserSettings} class="cursor-pointer rounded-lg py-1.5 px-3 hover:bg-gray-200 focused:bg-gray-200 text-themegreen">
