<script lang="ts">
  ...
  <aside class="z-[21] flex shrink-0 overflow-x-hidden max-md:!w-0 w-64 flex-col h-full bg-grey-700">
    <div class="draggable relative h-full w-full flex-1 items-start border-white/20">
        ...
        <nav class="flex h-full w-full flex-col px-3" aria-label={$t("app.historyChats")}>
          <!-- 顶部工具栏 -->
          <div class="flex justify-between flex h-[60px] items-center md:h-header-height">
            ...
            <div class="flex">
              <span class="flex">
                <button aria-label="Ctrl K" class="max-md:hidden h-10 rounded-lg px-2 text-themegreen focus-visible:outline-0 disabled:text-token-text-quaternary focus-visible:bg-themegreyhover enabled:hover:bg-themegreyhover" data-testid="search-button" type="button">
              ...
              <span class="flex">
                <button aria-label={$t("app.newChat")} data-tooltip={$t("app.newChat")} class="max-md:hidden h-10 rounded-lg px-2 text-themegreen focus-visible:outline-0 disabled:text-token-text-quaternary focus-visible:bg-themegreyhover enabled:hover:bg-themegreyhover" data-testid="clear-search-button" type="button">
          ...
          <div class="flex-col flex-1 transition-opacity duration-500 relative -mr-2 pr-2 overflow-y-auto">
            <div class="flex flex-col gap-2 text-token-text-primary text-sm false mt-2 pb-2">
