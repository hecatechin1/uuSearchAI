...
<div class="relative h-full w-full flex-1 overflow-auto transition-width overflow-hidden">
  ...
  <div class="composer-parent flex h-full flex-col focus-visible:outline-0 bg-gray-50">
    ...
    <div class="md:pt-0 md:border-transparent md:dark:border-transparent w-full  mb-2">
      <div class="m-auto text-base px-3 md:px-4 w-full md:px-5 lg:px-4 xl:px-5">
        <div class="mx-auto flex flex-1 gap-2 text-base md:max-w-3xl lg:max-w-[40rem] xl:max-w-[48rem] flex-col items-center">
