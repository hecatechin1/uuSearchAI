...
<div class="min-h-screen bg-gray-50 py-12">
  <div class="max-w-6xl mx-auto px-4">
    ...
    <!-- 定价卡片 (Pro -> Basic -> Free) -->
    <div class="grid md:grid-cols-3 auto-cols-auto gap-4 justify-center transition-all duration-300 ease-in-out ">
      {#if showCard_pro}
        <!-- pro(Pro)方案放在最前 -->
        <div
        ...
        >
          ...
          <div class="px-5 pt-10 pb-6 border-b border-gray-200">
            <h3 class="text-2xl font-semibold text-gray-800">
              ...
              <span><img class="inline-block h-6" src={saleRedIcon} alt={$t("pricing.specialPrice")}/></span>
            </h3>
            ...
            <!-- 价格区块 -->
              ...
              <div class="flex items-end gap-4 font-bold pb-3">
                <div class="flex flex-col">
                  <h5 class="text-themegreen text-lg ml-1">{$t("pricing.firstMonth")} </h5>
                  <h3
                ...
                <div class="flex flex-col text-sm text-gray-700 mt-1">
                  <p class="">
                    {$t("pricing.after")} {$t("pricing.monthly")}
                  </p>
                  <p>USD ${pricing.pro.monthlySubsequent}</p>
                  <p class="text-gray-400">{$t("pricing.yearlyPay")} ${pricing.pro.annualSubsequent} / {$t("pricing.perMonth")}</p>
                </div>
                {:else}
                <div class="flex flex-col text-sm text-gray-700 mt-1">
                  <p class="">
                    {$t("pricing.after")} {$t("pricing.yearly")}
                  </p>
                  <p>USD ${pricing.pro.annualSubsequent} /{$t("pricing.perMonth")}</p>
                  <p class="text-gray-400">总计 ${pricing.pro.annualTotal} USD</p>
                </div>
                {/if}
              </div>
        ...
        >
          ...
          <div class="px-5 pt-10 pb-6 border-b border-gray-200">
            <h3 class="text-2xl font-semibold text-gray-800">
              ...
              <span><img class="inline-block h-6" src={saleIcon} alt={$t("pricing.specialPrice")}/></span>
            </h3>
            <p class="mt-3 text-gray-600">
            ...
            <!-- 价格区块 -->
              ...
              <div class="flex items-end gap-4 font-bold pb-3">
                ...
                <div class="flex flex-col text-sm text-gray-700 mt-1">
                  ...
                  <p class="text-gray-400">{$t("pricing.yearlyPay")} ${pricing.basic.annualSubsequent} / {$t("pricing.perMonth")}</p>
                </div>
                {:else}
                <div class="flex flex-col text-sm text-gray-700 mt-1">
                  <p class="">
                  ...
                  <p>USD ${pricing.basic.annualSubsequent} /{$t("pricing.perMonth")}</p>
                  <p class="text-gray-400">总计 ${pricing.basic.annualTotal} USD</p>
                </div>
                {/if}
              </div>
      ...
      >
        ...
        <div class="px-5 bg-gray-50 py-6 flex-1 text-left">
          <!-- 价格区块 -->
            ...
            <div class="flex items-end gap-4 font-bold pb-3">
              <div class="flex flex-col">
                <h5 class="text-themegreen text-lg ml-1">{$t("pricing.current")}</h5>
                <h3
                  class="text-6xl text-themegreen inline-flex items-center gap-1"
                >
                  $0
