<script lang="ts">
  ...
  const pricing = {
    free: {
      features: ["pricing.freePlanFeature1", "pricing.freePlanFeature2"],
    },
    basic: {
    ...
    <div class="grid md:grid-cols-3 gap-8">
      {#if showCard_pro}
        ...
        <div
          ...
          class:outline={currentUserPlan === "pro" ||
        ...
        >
          ...
          <!-- 推荐角标 -->
          <div
            class="absolute top-0 right-0 bg-themegreen text-white text-xs font-bold py-1 px-3 rounded-bl"
          >
